 ...
 *
 * That divergence is not a defect to clean up.  This tool's d=24 result is
 * cited in docs/session_2026-09-05_emirp_d5_correction.md:68 as an
 * independent cross-check agreeing with hunt.c (EMIRPS=0, found=0).
