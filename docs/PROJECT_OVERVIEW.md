...
> corrected result: **`12641 ⟷ 14621` is the ONLY bi-quadratic emirp through 27
...
> ALL these survivors through d=27, only two are prime: the d=5 emirp and 3187813.
...
The next emirp, if any, has **d ≥ 28**. The density heuristic (Σ C/d² → expected total ≈ 1) is
...
3. **The central question:** do obstructions become *total* for all large `d`
   ...
   ~d=27), and a faster search (MITM) *and* a congruence non-existence proof have
